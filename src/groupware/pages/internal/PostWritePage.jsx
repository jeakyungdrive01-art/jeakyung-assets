...
export default function PostWritePage() {
  ...
  return <article className="gw-page" aria-labelledby="write-title">
    <header className="gw-page-header"><div><span className="gw-eyebrow">WRITE</span><h1 id="write-title">{overview.board.name} {postId ? '글 수정' : '글쓰기'}</h1><p>본문 이미지는 비공개 저장소에 업로드되며 게시판 권한을 서버에서 다시 검증합니다.</p></div></header>
