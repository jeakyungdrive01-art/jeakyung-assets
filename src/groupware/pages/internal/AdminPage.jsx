  ...
  return (
    <article className="gw-page gw-admin-page" aria-labelledby="page-title">
      <header className="gw-page-header">
        ...
        <div className="gw-admin-actions"><Link className="gw-primary-button" to="/admin/boards">게시판 관리</Link><Link className="gw-secondary-button" to="/admin/popups">팝업 문서 관리</Link></div>
      </header>
