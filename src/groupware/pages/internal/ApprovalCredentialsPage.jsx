...
export default function ApprovalCredentialsPage() {
  ...
  return <article className="gw-approval-page" aria-labelledby="approval-credential-title">
    <header className="gw-approval-heading"><div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}><button type="button" className="gw-back-icon-button" onClick={() => navigate('/groupware/approval')} aria-label="전자결재 홈으로"><svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6" /></svg></button><div><span className="gw-eyebrow">MY APPROVAL MARK</span><h1 id="approval-credential-title">도장·서명 관리</h1><p>승인할 때 사용할 도장이나 자필 서명을 등록합니다. 승인 이력에는 사용한 이미지가 고정 기록됩니다.</p></div></div></header>
