    ...
    <div className="content-width">
      ...
      <div className="service-grid">
        <article className="service-card service-featured reveal">
          ...
          <a href={consultationUrl} data-service="3PL 물류대행" target="_blank" rel="noopener noreferrer" aria-label="3PL 물류대행 카카오톡 상담, 새 창">3PL 상담 시작하기 <span aria-hidden="true">→</span></a>
        </article>
        ...
        <article className="service-card service-featured reveal">
          ...
          <a href={consultationUrl} data-service="신선식품 풀필먼트" target="_blank" rel="noopener noreferrer" aria-label="신선식품 풀필먼트 카카오톡 상담, 새 창">신선물류 상담하기 <span aria-hidden="true">→</span></a>
        </article>
        ...
        <article className="service-card reveal">
          ...
          <a href={consultationUrl} data-service="기업운송" target="_blank" rel="noopener noreferrer" aria-label="기업운송 카카오톡 상담, 새 창">기업운송 문의하기 <span aria-hidden="true">→</span></a>
        </article>
        ...
        <article className="service-card reveal">
          ...
          <a href={consultationUrl} data-service="보관물류" target="_blank" rel="noopener noreferrer" aria-label="보관물류 카카오톡 상담, 새 창">보관물류 문의하기 <span aria-hidden="true">→</span></a>
        </article>
        ...
        <article className="service-card reveal">
          ...
          <a className="consulting-cta" href={consultationUrl} data-service="물류컨설팅" target="_blank" rel="noopener noreferrer" aria-label="물류컨설팅 카카오톡 상담, 새 창">컨설팅 문의하기 <span className="cta-arrow" aria-hidden="true">→</span></a>
        </article>
      </div>
    </div>
  );
